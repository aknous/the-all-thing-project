  ...
  return (
    <PublicLayout categories={categories} visibleSections={visibleSections} newPollsCount={newPolls.length}>
      <div className="max-w-3xl mx-auto px-6 pb-8">
        ...
        {/* New Polls Section */}
        {newPolls.length > 0 && (
          <section id="new" className="mt-12 pt-8 scroll-mt-20 border-t border-zinc-200 dark:border-zinc-800">
            <div className="mb-8">
        ...
        {/* About Section */}
        <section id="about" className="mt-20 pt-16 border-t border-zinc-200 dark:border-zinc-800 scroll-mt-20">
          ...
          <div className="space-y-4 text-left text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <p>
        ...
        {/* FAQ Section */}
        <section id="faq" className="mt-20 pt-16 border-t border-zinc-200 dark:border-zinc-800 scroll-mt-20">
